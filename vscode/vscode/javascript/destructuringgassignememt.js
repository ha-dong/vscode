...
// 이터러블이나 객체의 구성요소(요소, 프라퍼티)들을 각각의 변수에 할당
...
// console.log(name, rest); // 홍길동, { age: 30, gender: '남', address: '어딘가' }
...
// const {name, age, hobby} = hong;
// console.log(name, age, hobby); //홍길동 20 ['축구', '독서', '등산']

// const[soccer, reading, climing] = hobby;
// console.log(soccer, reading, climing);// 축구 독서 등산

//배열 내의 객체 구조분해할당
const persons = [
    {name:'홍길동', age: 20, gender:'남'},
    {name:'홍길순', age: 30, gender:'여'}
];
