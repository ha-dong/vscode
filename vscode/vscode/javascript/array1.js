...
console.log(arr5);//[undefined, endefined]
...
//희소 배열(sparce array): 요소가 중간중간 있는 배열
...
//배열 요소 추가/삭제
const arr8 = arr7.push(6);//배열 끝에 요소
console.log(arr7); 
console.log(arr8); //length

const arr9 = arr7.pop(6);//배열 끝에 요소 제거
console.log(arr7);
...
console.log(arr21.sort());//ascending 차례로 나옴
console.log(arr21.sort((a, b) => b-a));//descending 역순으로 나옴
console.log("---------");
...
console.log(arr21.find(person => person.age == 40));
